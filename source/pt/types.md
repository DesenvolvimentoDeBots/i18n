...
| inline_query           | InlineQuery (Consulta Inline) | false (Falso)     | New incoming inline query                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| pending_update_count   | Integer (Número)                 | true (Verdadeiro) | Number of updates awaiting delivery                                                                                         |
| last_error_date        | Integer (Número)                 | false (Falso)     | Unix time for the most recent error that happened when trying to deliver an update via webhook                              |
...
| forward_from_message_id | Integer (Número)                 | false (Falso)     | For messages forwarded from channels, identifier of the original message in the channel                                                                                                                                                                                                                                                                 |
...
| forward_date              | Integer (Número)                 | false (Falso)     | For forwarded messages, date the original message was sent in Unix time                                                                                                                                                                                                                                                                                 |
| reply_to_message        | Message (Mensagem)               | false (Falso)     | For replies, the original message. Note that the Message object in this field will not contain further reply_to_message fields even if it itself is a reply.                                                                                                                                                                                          |
| edit_date                 | Integer (Número)                 | false (Falso)     | Date the message was last edited in Unix time                                                                                                                                                                                                                                                                                                           |
...
| width     | Integer (Número)                 | true (Verdadeiro) | Photo width                     |
| height    | Integer (Número)                 | true (Verdadeiro) | Photo height                    |
