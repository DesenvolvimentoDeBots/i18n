...
| has_custom_certificate | Boolean                          | true (Verdadeiro) | True, if a custom certificate was provided for webhook certificate checks                                                   |
| pending_update_count   | Interger (Número)                | true (Verdadeiro) | Number of updates awaiting delivery                                                                                         |
| last_error_date        | Interger (Número)                | false             | Unix time for the most recent error that happened when trying to deliver an update via webhook                              |
| last_error_message     | String (Sequência de caracteres) | false             | Error message in human-readable format for the most recent error that happened when trying to deliver an update via webhook |
| max_connections          | Interger (Número)                | false             | Maximum allowed number of simultaneous HTTPS connections to the webhook for update delivery                                 |
| allowed_updates          | Array de String                  | false             | A list of update types the bot is subscribed to. Defaults to all update types                                               |
...
| is_bot        | Boolean                          | true (Verdadeiro) | True, if this user is a bot              |
| first_name    | String (Sequência de caracteres) | true (Verdadeiro) | User‘s or bot’s first name               |
| last_name     | String (Sequência de caracteres) | false             | User‘s or bot’s last name                |
| username      | String (Sequência de caracteres) | false             | User‘s or bot’s username                 |
| language_code | String (Sequência de caracteres) | false             | IETF language tag of the user's language |
...
| title                            | String (Sequência de caracteres) | false             | Title, for supergroups, channels and group chats                                                                                                                                                                                                                                                    |
| username                         | String (Sequência de caracteres) | false             | Username, for private chats, supergroups and channels if available                                                                                                                                                                                                                                  |
| first_name                       | String (Sequência de caracteres) | false             | First name of the other party in a private chat                                                                                                                                                                                                                                                     |
| last_name                        | String (Sequência de caracteres) | false             | Last name of the other party in a private chat                                                                                                                                                                                                                                                      |
...
| description                      | String (Sequência de caracteres) | false             | Description, for supergroups and channel chats. Returned only in getChat.                                                                                                                                                                                                                           |
| invite_link                      | String (Sequência de caracteres) | false             | Chat invite link, for supergroups and channel chats. Returned only in getChat.                                                                                                                                                                                                                      |
| pinned_message                   | Message                          | false             | Pinned message, for supergroups and channel chats. Returned only in getChat.                                                                                                                                                                                                                        |
| sticker_set_name               | String (Sequência de caracteres) | false             | For supergroups, name of group sticker set. Returned only in getChat.                                                                                                                                                                                                                               |
...
| forward_from_message_id | Interger (Número)                | false             | For messages forwarded from channels, identifier of the original message in the channel                                                                                                                                                                                                                                                         |
| forward_signature         | String (Sequência de caracteres) | false             | For messages forwarded from channels, signature of the post author if present                                                                                                                                                                                                                                                                   |
| forward_date              | Interger (Número)                | false             | For forwarded messages, date the original message was sent in Unix time                                                                                                                                                                                                                                                                         |
...
| edit_date                 | Interger (Número)                | false             | Date the message was last edited in Unix time                                                                                                                                                                                                                                                                                                   |
| media_group_id          | String (Sequência de caracteres) | false             | The unique identifier of a media message group this message belongs to                                                                                                                                                                                                                                                                          |
| author_signature          | String (Sequência de caracteres) | false             | Signature of the post author for messages in channels                                                                                                                                                                                                                                                                                           |
| text                      | String (Sequência de caracteres) | false             | For text messages, the actual UTF-8 text of the message, 0-4096 characters.                                                                                                                                                                                                                                                                     |
...
| caption                   | String (Sequência de caracteres) | false             | Caption for the audio, document, photo, video or voice, 0-200 characters                                                                                                                                                                                                                                                                        |
...
| new_chat_title          | String (Sequência de caracteres) | false             | A chat title was changed to this value                                                                                                                                                                                                                                                                                                          |
...
| migrate_to_chat_id      | Interger (Número)                | false             | The group has been migrated to a supergroup with the specified identifier. This number may be greater than 32 bits and some programming languages may have difficulty&#x2F;silent defects in interpreting it. But it is smaller than 52 bits, so a signed 64 bit integer or double-precision float type are safe for storing this identifier.   |
| migrate_from_chat_id    | Interger (Número)                | false             | The supergroup has been migrated from a group with the specified identifier. This number may be greater than 32 bits and some programming languages may have difficulty&#x2F;silent defects in interpreting it. But it is smaller than 52 bits, so a signed 64 bit integer or double-precision float type are safe for storing this identifier. |
...
| connected_website         | String (Sequência de caracteres) | false             | The domain name of the website on which the user has logged in. More about Telegram Login »                                                                                                                                                                                                                                                     |
...
| url    | String (Sequência de caracteres) | false             | For “text_link” only, url that will be opened after user taps on the text                                                                                                                                                                                   |
...
| file_size | Interger (Número)                | false             | File size                       |
...
| performer | String (Sequência de caracteres) | false             | Performer of the audio as defined by sender or by audio tags |
| title     | String (Sequência de caracteres) | false             | Title of the audio as defined by sender or by audio tags     |
| mime_type | String (Sequência de caracteres) | false             | MIME type of the file as defined by sender                   |
| file_size | Interger (Número)                | false             | File size                                                    |
...
| file_name | String (Sequência de caracteres) | false             | Original filename as defined by sender     |
| mime_type | String (Sequência de caracteres) | false             | MIME type of the file as defined by sender |
| file_size | Interger (Número)                | false             | File size                                  |
...
| mime_type | String (Sequência de caracteres) | false             | Mime type of a file as defined by sender              |
| file_size | Interger (Número)                | false             | File size                                             |
...
| user_id      | Interger (Número)                | false             | Contact's user identifier in Telegram |
...
| --------- | -------------------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| file_id   | String (Sequência de caracteres) | true (Verdadeiro) | Unique identifier for this file                                                                                                                   |
| file_size | Interger (Número)                | false             | File size, if known                                                                                                                               |
| file_path | String (Sequência de caracteres) | false             | File path. Use https:&#x2F;&#x2F;api.telegram.org&#x2F;file&#x2F;bot&lt;token&gt;&#x2F;&lt;file_path&gt; to get the file. |
...
| url                                  | String (Sequência de caracteres) | false             | HTTP url to be opened when button is pressed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| callback_data                        | String (Sequência de caracteres) | false             | Data to be sent in a callback query to the bot when button is pressed, 1-64 bytes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| switch_inline_query                | String (Sequência de caracteres) | false             | If set, pressing the button will prompt the user to select one of their chats, open that chat and insert the bot‘s username and the specified inline query in the input field. Can be empty, in which case just the bot’s username will be inserted.Note: This offers an easy way for users to start using your bot in inline mode when they are currently in a private chat with it. Especially useful when combined with switch_pm… actions – in this case the user will be automatically returned to the chat they switched from, skipping the chat selection screen. |
| switch_inline_query_current_chat | String (Sequência de caracteres) | false             | If set, pressing the button will insert the bot‘s username and the specified inline query in the current chat's input field. Can be empty, in which case only the bot’s username will be inserted.This offers a quick way for the user to open your bot in inline mode in the same chat – good for selecting something from multiple options.                                                                                                                                                                                                                            |
...
| inline_message_id | String (Sequência de caracteres) | false             | Identifier of the message sent via the bot in inline mode, that originated the query.                                                                  |
...
| data                | String (Sequência de caracteres) | false             | Data associated with the callback button. Be aware that a bad client can send arbitrary data in this field.                                            |
| game_short_name   | String (Sequência de caracteres) | false             | Short name of a Game to be returned, serves as the unique identifier for the game                                                                      |
...
| until_date                    | Interger (Número)                | false             | Restricted and kicked only. Date when restrictions will be lifted for this user, unix time                                                                                                                                                        |
...
| -------------------- | ----------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| migrate_to_chat_id | Interger (Número) | false     | The group has been migrated to a supergroup with the specified identifier. This number may be greater than 32 bits and some programming languages may have difficulty&#x2F;silent defects in interpreting it. But it is smaller than 52 bits, so a signed 64 bit integer or double-precision float type are safe for storing this identifier. |
| retry_after          | Interger (Número) | false     | In case of exceeding flood control, the number of seconds left to wait before the request can be repeated                                                                                                                                                                                                                                     |
...
| duration           | Interger (Número)                | false             | Video duration                                                                                                                                                                                                                                                                                                                                                       |
...
| emoji         | String (Sequência de caracteres) | false             | Emoji associated with the sticker                               |
| set_name      | String (Sequência de caracteres) | false             | Name of the sticker set to which the sticker belongs            |
...
| contains_masks | Boolean                          | true (Verdadeiro) | True, if the sticker set contains masks |
...
| x_shift | Float number                     | true (Verdadeiro) | Shift by X-axis measured in widths of the mask scaled to the face size, from left to right. For example, choosing -1.0 will place mask just to the left of the default mask position. |
| y_shift | Float number                     | true (Verdadeiro) | Shift by Y-axis measured in heights of the mask scaled to the face size, from top to bottom. For example, 1.0 will place the mask just below the default mask position.               |
| scale   | Float number                     | true (Verdadeiro) | Mask scaling coefficient. For example, 2.0 means double size.                                                                                                                         |
...
| inline_message_id | String (Sequência de caracteres) | false             | Identifier of the sent inline message. Available only if there is an inline keyboard attached to the message. Will be also received in callback queries and can be used to edit the message. |
...
| Campo            | Tipo                             | Requerido | Descrição             |
| ---------------- | -------------------------------- | --------- | --------------------- |
| name             | String (Sequência de caracteres) | false     | User name             |
| phone_number     | String (Sequência de caracteres) | false     | User's phone number   |
| email            | String (Sequência de caracteres) | false     | User email            |
...
| shipping_option_id         | String (Sequência de caracteres) | false             | Identifier of the shipping option chosen by the user                                                                                                                                                                                                                                                  |
...
| text          | String (Sequência de caracteres) | false             | Brief description of the game or high scores included in the game message. Can be automatically edited to include current high scores for the game when the bot calls setGameScore, or manually edited using editMessageText. 0-4096 characters. |
...
| file_name | String (Sequência de caracteres) | false             | Original animation filename as defined by sender |
| mime_type | String (Sequência de caracteres) | false             | MIME type of the file as defined by sender       |
| file_size | Interger (Número)                | false             | File size                                        |
