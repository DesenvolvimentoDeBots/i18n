...
| Campo                     | Tipo                             | Requerido         | Descrição                                                                                                                                                                                                                                                                                                                                       |
| ------------------------- | -------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| message_id                | Interger (Número)                | true (Verdadeiro) | Identificador exclusivo de mensagem dentro deste chat                                                                                                                                                                                                                                                                                           |
| from                      | User                             | false (Falso)     | Remetente, vazio para mensagens enviadas para canais                                                                                                                                                                                                                                                                                            |
| date                      | Interger (Número)                | true (Verdadeiro) | Data em que a mensagem foi enviada em Unix time                                                                                                                                                                                                                                                                                                 |
